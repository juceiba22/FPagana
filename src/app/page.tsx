          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {[
                ...
                { name: "Gugú Petite-Mort", role: "La Magia de la Maga", desc: "Portadora de un misticismo cautivante, envuelve la noche con magia y una sensualidad a flor de piel. Su presencia enigmática conecta el mundo visible con los misterios más profundos del ritual.", icon: "🔮" },
